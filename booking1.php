...
<?php
    ...
    $sql4 = "SELECT * FROM  cars c, driver d, rentedcars rc WHERE c.car_id = '$car_id' AND d.driver_id = '$driver_id' AND customer_username = driver_name";
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            <div class="col-md-10" style="float: none; margin: 0 auto; ">
                ...
                if($charge_type = "days"){
                ?>
                     <h4> <strong>Fare:</strong> Rp. <?php echo $fare; ?>/day</h4>
                <?php } ?>
                ...
                <br>
                <a class="btn btn-warning pull-left" href="user_page.php"> Back</a>
            </div>
        </div>
